...
function control() {
  ...
  // Construct dom
  button1.appendChild(document.createTextNode("Рассчитать "));
  button1.appendChild(text2);
  button1.appendChild(document.createTextNode(" разряд"));
  button1.setAttribute("class", "btn btn-primary");
  button1.setAttribute("name", "next_digit_number");
  form0.appendChild(button1);
  ...
  this.__update__ = {
    next_digit_number: function (next_digit_number) {
      text2.textContent = next_digit_number;
      button1.value = next_digit_number;;
    }
  };
